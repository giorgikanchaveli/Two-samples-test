# This is modified dlip_old computation code


# We have 3 main functions for dlip_old: 
...
function dlip_old(atoms_1::AbstractArray{Float64,2}, atoms_2::AbstractArray{Float64,2}, a::Float64, b::Float64, nGrid::Int = 250,nSteps::Int=1000,
...
function dlip_old(h_1::HierSample, h_2::HierSample, a::Float64, b::Float64, nGrid::Int = 250)
    return dlip_old(h_1.atoms, h_2.atoms, a, b, nGrid)
end


function dlip_old(atoms_1::Matrix{Float64}, atoms_2::Matrix{Float64}, 
    ...
    # Difference compared to the dlip_old above is how it projects atoms on a grid. In particular,
...
function dlip_old_diffsize(atoms_1::Matrix{Float64}, atoms_2::Matrix{Float64}, 
              weights_1::Matrix{Float64}, weights_2::Matrix{Float64}, a::Float64, b::Float64;
              nGrid::Int = 250, maxTime::Float64 = 0.5)
