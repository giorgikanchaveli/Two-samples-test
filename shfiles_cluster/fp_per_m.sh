#!/bin/bash -l
#SBATCH --job-name=fp_per_m                        # name of the SLURM job (shows up in queue)
...
julia --project=. simulations/fp_per_m.jl --label_q ${label_q} --n ${n} --S ${S} --n_perm ${n_perm}
