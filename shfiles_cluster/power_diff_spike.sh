#!/bin/bash -l
#SBATCH --job-name=power_diff_spike               # name of the SLURM job (shows up in queue)
...
julia --project=. simulations/power_diff_spike_save.jl --n ${n} --m ${m} --S ${S} --n_samples ${n_samples}
