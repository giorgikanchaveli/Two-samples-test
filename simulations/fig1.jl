...
scatter!(pl, n_tops, d_ww, label = "ww")
scatter!(pl, n_tops, d_lip, label = "dlip")
scatter!(pl, n_tops, d_trues, label = "true value")




filepath = joinpath(pwd(),"plots")
savefig(pl, joinpath(filepath, "fig_1_$(n_top)_$(n_bottom)"))