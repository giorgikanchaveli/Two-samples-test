...
function pvalue_np(hier_sample_1::HierSample, hier_sample_2::HierSample, n_permutations::Int)
...
function decision_np(hier_sample_1::HierSample, hier_sample_2::HierSample, θ::Float64, n_permutations::Int)
    return Float64(pvalue_np(hier_sample_1, hier_sample_2, n_permutations)< θ)
end
...
q_1 = DP(10000.0, Beta(1,1))
q_2 = DP(10000.0, Beta(1,1))  
n, m = 100, 100
n_permutations = 100
S = 100
θ = 0.05
